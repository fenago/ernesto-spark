...
object ratingsByMovies {
  ...
  def loadMovieNames(): Map[Int, String] = {
    ...
    val data = Source.fromFile("/headless/Desktop/ernesto-spark/Files/chapter_6/movies.csv").getLines()
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("/headless/Desktop/ernesto-spark/Files/chapter_6/ratings.csv")
