...
- Start IntelliJ IDE and open `~/work/ernesto-spark/src/main/scala/training/sqlJoins.scala` to view scala file.
...
**Step 3:** Start IntelliJ IDE and open `~/work/ernesto-spark/src/main/scala/training/sqlJoins.scala` to view scala file.
